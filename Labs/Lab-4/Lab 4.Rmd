...
untidy3.school = untidy2.school %>%
                    ...
                    gather(Year, Value, `2017`:`2018`, convert = TRUE)
...
tidy2.school=tidy.school %>%
  complete(school, student, Year, explicit = TRUE)
```
...
If Lebron James keeps his word, he should give money to schools that had the greatest meedian increase and also lowest overlap of IQRs. But personally, I dont think that the schools acted in the spirit of his mission.
...
Students scores pior to the inflation do not reflect proprtionally their percentile. That is to say, being a high percentile student one year, does not mean you will be one the next. That makes me feel that these students didn't really learn, and students with bad grades got their sccores bumped up.

Conversly you could take this to mean that this program really did help some students and the lack of coorelation between the two years in percentiles show that there wasnt a flat grade bump. You would have to look into it more.

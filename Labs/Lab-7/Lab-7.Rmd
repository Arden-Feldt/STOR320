...
cat("The number of non-negative observations is", non_negative_count, "\n")
cat("The number of negative observations is", negative_count, "\n")
```
...
```{r,eval=T}
A = matrix(1:1000000, nrow = 100000, byrow = TRUE) # DO NOT CHANGE
...
for (col_name in names(iris)) {
  num_unique <- length(unique(iris[[col_name]]))
  
  cat("The number of unique values for", col_name, "is", num_unique, "\n")
}
```
